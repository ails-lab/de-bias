...
df = pd.read_csv(os.path.join(VOCABULARIES_PATH, 'DE-BIAS Vocabulary v2 - Nederlands.csv'))
...
df = df[['uri', 'context', 'term', 'disambiguation']]
df = df.dropna()

df.to_csv(os.path.join(VOCABULARIES_PATH,
                       'DE-BIAS Vocabulary v2 - Nederlands_clean.csv'),
